...
// ---- Functions -----------------------------------------------------------------------------
    ...
    */
    ...
    void CompileSourceFile ()
    {
		...
		g_iTempArrayIndexSymbolIndex = AddSymbol(TEMP_ARRAY_INDEX, 1, SCOPE_GLOBAL, SYMBOL_TYPE_VAR);
    ...
    */
    ...
    void AssmblOutputFile ()
    {
        ...
        _spawnv ( P_WAIT, "XASM.exe", ppstrCmmndLineParams );
